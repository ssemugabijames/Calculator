        ...
        <div className='frame'>
            <div className='calculator'>
                ...
                <Output user={input} answer={result}/>
                 <img src={logo} width='300px' height='90px' style={{display:'block',marginLeft:'auto' ,marginRight:' auto'}}/>
                 <div className='key'>
                    ...
                    <input type='button' value={'='} className='button equal-sign' onClick={handleClick}></input>                 </div>
            </div>
